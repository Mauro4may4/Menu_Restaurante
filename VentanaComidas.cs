...
{
    public partial class VentanaComidas : Form
    {
        ...
        private void Poblar()
        {
            ...
            {
                da = new SqlDataAdapter("select Id_producto, descripcion, precio from productos where categorias='Comidas'", conexion);
                da.SelectCommand.Parameters.AddWithValue("Comidas", Categoria);
                ds = new DataSet();
                da.Fill(ds);
